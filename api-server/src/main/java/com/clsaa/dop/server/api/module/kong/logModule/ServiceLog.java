...
public class ServiceLog {
    ...
    public ServiceLog(String host, String created_at, Long connect_timeout, String id, String protocol, String name,
                      Long read_timeout, Long port, String path, String updated_at, Long retries, Long write_timeout) {
        this.host = host;
