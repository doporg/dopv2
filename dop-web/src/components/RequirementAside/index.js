...
import { requirementMenuConfig as asideMenuConfig } from './requirementMenuConfig';
...
class RequirementAside extends Component {
    static propTypes = {};
...
export default withRouter(RequirementAside);
